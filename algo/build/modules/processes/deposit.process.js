...
var AlgoDepositProcess = /** @class */ (function () {
    function AlgoDepositProcess() {
        var _this = this;
        this.startDepositQueue = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rabbitMq_1.default.consumeQueue("" + process.env.DEPOSIT_QUEUE_BLOCKS_PROCESS, this.checkIfOurTx)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.checkIfOurTx = function (data) { return __awaiter(_this, void 0, void 0, function () {
            var account, queryIfToken, queryIfAlgo, webhookTx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!data.token) return [3 /*break*/, 2];
                        queryIfToken = "SELECT * FROM coins AS co INNER JOIN wallets AS wa ON wa.coin_id=co.coin_id WHERE co.token_address='" + data.token + "' AND wa.wallet_address LIKE '" + data.toAddress + "' AND co.coin_family=" + process.env.COIN_FAMILY + " LIMIT 1";
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        queryIfAlgo = "SELECT * FROM coins AS co INNER JOIN wallets AS wa ON wa.coin_id=co.coin_id WHERE co.coin_symbol='" + process.env.NETWORK + "' AND wa.wallet_address LIKE '" + data.toAddress + "' AND co.coin_family=" + process.env.COIN_FAMILY + " LIMIT 1";
                        return [4 /*yield*/, db_1.default.db.query(queryIfAlgo, {
                                type: sequelize_1.default.QueryTypes.SELECT,
                            })];
                    case 3:
                        account = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        webHookUrlApi = process.env.WEBHOOK_API_DEPOSIT_BLOCK_PROCESS || "";
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log("catch error deposit addTransactionToDB :", error_1);
    ...
    return AlgoDepositProcess;
}());
var algoDepositProcess = new AlgoDepositProcess();
exports.default = algoDepositProcess;
